...
function BodyReader(options) {
    ...
    var xmlElementReaders = {
        "oMath": function (element) {
            ...
            return elementResult(new documents.Text("</thisismath>"));
        },
    ...
    function readImage(imageFile, altText, titleText) {

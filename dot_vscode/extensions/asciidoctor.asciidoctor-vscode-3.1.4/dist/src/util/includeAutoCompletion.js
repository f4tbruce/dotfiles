...
exports.AsciidocTargetPathAutoCompletionMonitor = void 0;
...
class AsciidocTargetPathAutoCompletionMonitor {
    constructor(asciidocLoader) {
        ...
        const disposable = vscode.languages.registerCompletionItemProvider({
            language: 'asciidoc',
            scheme: 'file',
        }, new asciidoc_provider_1.TargetPathCompletionProvider(asciidocLoader), ...[':', '/']);
...
exports.AsciidocTargetPathAutoCompletionMonitor = AsciidocTargetPathAutoCompletionMonitor;
